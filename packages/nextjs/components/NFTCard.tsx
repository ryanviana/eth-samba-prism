...
const style = {
  ...
  orderTab: `absolute bottom-0 left-0 right-0 top-auto blue-glassmorphism py-5 px-2 rounded-b-2xl transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out flex flex-col justify-center items-center`,
  sizeLabel: `mr-2 self-center`,
  sizeWrapper: `flex items-center justify-center mb-5`,
  sizeSelect: `inline-block bg-[#273359] py-1 px-3 rounded text-center cursor-pointer`,
  ...
  modalContent: `bg-[#273359] rounded-3xl shadow-md shadow-secondary border border-base-300 max-w-lg w-full p-6 relative`,
  closeModalButton: `bg-[#273359] p-2 rounded-full absolute top-4 right-2 mt-2 mr-2`,
